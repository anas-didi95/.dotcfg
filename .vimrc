...
autocmd FileType cpp noremap <F5> :w <bar> exec '!./'.shellescape('%:r').' < i1 > o1 && diff -s o1 a1'<CR>
autocmd FileType cpp noremap <F6> :w <bar> exec '!./'.shellescape('%:r').' < i2 > o2 && diff -s o2 a2'<CR>
